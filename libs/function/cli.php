...
function create_require_dir()
{
     ...
     * 建立静态文件的目录
     */
    if(!is_dir(WEBPATH.'/staticps')) mkdir(WEBPATH.'/staticps',0755);
    if(!is_dir(WEBPATH.'/staticps/images')) mkdir(WEBPATH.'/staticps/images',0755);
    if(!is_dir(WEBPATH.'/staticps/css')) mkdir(WEBPATH.'/staticps/css',0755);
    if(!is_dir(WEBPATH.'/staticps/uploads')) mkdir(WEBPATH.'/staticps/uploads',0755);
    if(!is_dir(WEBPATH.'/staticps/js')) mkdir(WEBPATH.'/staticps/js',0755);
